					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="department_id" id="department_id" class="form-control form-control-sm select2">
								<option value=""></option>
								<?php 
								$departments = $conn->query("SELECT * FROM lista_departamentos order by department asc");
						...
						<div class="form-group">
							...
							<select name="designation_id" id="designation_id" class="form-control form-control-sm select2">
								<option value=""></option>
								<?php 
								$designations = $conn->query("SELECT * FROM lista_cargos order by designation asc");
						...
						<div class="form-group">
							...
							<select name="evaluator_id" id="evaluator_id" class="form-control form-control-sm select2">
								<option value=""></option>
								<?php 
								$evaluators = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM lista_evaluadores order by concat(lastname,', ',firstname,' ',middlename) asc");
