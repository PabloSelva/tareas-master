...
<div class="container-fluid">
	<div id="post-field">
	<?php 
	$progress = $conn->query("SELECT p.*,concat(u.firstname,' ',u.lastname) as uname,u.avatar FROM progreso_tareas p inner join lista_tareas t on t.id = p.task_id inner join lista_miembros u on u.id = t.employee_id where p.task_id = $id order by unix_timestamp(p.date_created) desc ");
