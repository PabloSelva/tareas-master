 <link rel="stylesheet" href="../tareas-master/assets/dist/css/styles.css" class="css"> 
    ...
    <div class="dropdown">
   	...
   	<a href="./" class="brand-link">
        ...
        <h3 class="text-center p-0 m-0"><b>Evaluador</b></h3>
         <?php else: ?>
        <h3 class="text-center p-0 m-0"><b>Miembro</b></h3>
        <?php endif; ?>
